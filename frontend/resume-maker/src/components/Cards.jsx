...
export const TemplateCard=({thumbnailImg,isSelected,onSelect})=>{
    return(
        <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2
            overflow-hidden cussor-pointer transition-all duration-500
            ...
            ${
                ...
                {thumbnailImg?(
                    <div className="relative w-full h-full overflow-hidden">
                        ...
                        {isSelected &&(
                            <div className="absolute inset-0 bg-violet-500/10 flex items-center
                            justify-center">
                                <div className="w-16 h-16 bg-white backdrop-blur-sm rounded-full
                        ...
                        <div className="absolute insert-0 bg-gradient-to-t from-violet-100/30 to-transparent
                    ...
                    from-violet-50 via-violet-600 to bg-fuchsia-50">
                        <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to bg-fuchsia-500
                         rounded-2xl flex  items-center justify-center mb-3">
                            <Edit className="tetx-white" size={20}/>
