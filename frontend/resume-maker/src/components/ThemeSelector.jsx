...
const ThemeSelector = ({ selectedTheme, setSelectedTheme, resumeData, onClose }) => {
  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
      ...
      p-4 sm:p-4 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
        <Tabs tabs={TAB_DATA} activeTab={tabValue} setActiveTab={setTabValue} />
        <button className='w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r
        from-violet-600 to to-fuchsia-600 text-white font-black rounded-2xl
      ...
      <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
        ...
        border-gray-100 p-4 sm:p-6'>
          <div className='grid grid-cols-1 gap-4 max-h-[60vh] lg:max-h=[70vh]
            overflow-auto p-2'>
