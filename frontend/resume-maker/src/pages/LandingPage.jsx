...
import { ArrowRight, LayoutTemplate, LucideHandFist, Menu, X, Zap, Download } from "lucide-react";
                    ...
                    <div className={landingPageStyles.heroGrid}>
                        <div className={landingPageStyles.heroLeft}>
                            ...
                            <div className={landingPageStyles.ctaButton}>
                                <button
                                    className={landingPageStyles.primaryButtons}
                                    onClick={handleCTA}
                                >
                            ...
                            <div className={landingPageStyles.statsContainer}>
                                {[
                                    ...
                                    <div className={landingPageStyles.statItem} key={idx}>
                                        <div
                                            className={`bg-gradient-to-r ${stat.gradient} ${landingPageStyles.statNumber}`}
                                        >
                                            {stat.value}
                                        </div>
                    ...
                    <div className={landingPageStyles.featuresContainer}>
                        <div className={landingPageStyles.featuresHeader}>
                            <h2 className={landingPageStyles.featureTitle}>
                                Why Choose <span className={landingPageStyles.featuresTitleGradient}>Resume Expert?</span></h2>
            ...
            <footer className={landingPageStyles.footer}>
                <div className={landingPageStyles.footerContainer}>
                    <p className={landingPageStyles.footerText}>
                        Crafted with <span className={landingPageStyles.footerHeart}>❤️</span> by{'Vansh Singh'}
                        {/* <a href="http://hexagondigitalservices.com/webdev" target="_blank" className={landingPageStyles.footerLink}>
